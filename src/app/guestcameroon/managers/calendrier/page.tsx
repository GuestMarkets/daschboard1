...
function EventModal({
  ...
  const initialTaskId: number | "" =
    typeof defaults?.taskId === "number" ? defaults.taskId : "";
  ...
  useEffect(() => {
    ...
    setTaskId(typeof defaults?.taskId === "number" ? defaults.taskId : "");
    setErr(null);
    setSaving(false);
    setSyncGoogle(false);
              ...
              <div className="ml-auto flex items-center gap-2">
                {!googleConnected ? (
                  ...
                  <button
                    onClick={async () => {
                      try {
                        await fetchJSON("/api/calendar/google/disconnect", {
                          method: "POST",
                        });
