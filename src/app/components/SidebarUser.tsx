...
export default function SidebarSoft({
  ...
  const NAV: Item[] = React.useMemo(
    () =>
      items ?? [
        { href: "/guestmarkets/users/overview", label: "Vue d’ensemble", icon: Home },
        {
          label: "Utilisateur",
          icon: Users,
          children: [
            { href: "/guestmarkets/users/users", label: "Employés", icon: UsersIcon },
            { href: "/guestmarkets/users/users/managers", label: "Responsables", icon: UserIcon },
          ],
        },
        { href: "/guestmarkets/users/departements", label: "Départements", icon: Building2 },
        {
          label: "Projets",
          icon: FolderKanban,
          children: [
            { href: "/guestmarkets/users/projets", label: "Pour moi", icon: UserIcon },
            { href: "/guestmarkets/users/projets/tous", label: "Tout le monde", icon: UsersIcon },
          ],
        },
        {
          label: "Tâches",
          icon: CheckSquare,
          children: [
            { href: "/guestmarkets/users/tasks/personnelle", label: "Pour moi", icon: ListChecks },
            { href: "/guestmarkets/users/tasks", label: "Tout le monde", icon: UsersIcon },
          ],
        },
        { href: "/guestmarkets/users/calendrier", label: "Calendrier", icon: CalendarIcon },
        { href: "/guestmarkets/users/rapports", label: "Rapports", icon: BarChart3 },
        {
          label: "Planning",
          icon: CalendarCheck,
          children: [
            { href: "/guestmarkets/users/planning", label: "Pour moi", icon: CalendarCheck },
            { href: "/guestmarkets/users/planning/all", label: "Tout le monde", icon: CalendarCheck },
          ],
        },
        {
          label: "Objectifs",
          icon: Target,
          children: [
            { href: "/guestmarkets/users/objectives", label: "Pour moi", icon: Target },
            { href: "/guestmarkets/users/objectives/all", label: "Tout le monde", icon: Target },
          ],
        },
        { href: "/guestmarkets/users/chat", label: "Chat", icon: MessageSquare },
        { href: "/guestmarkets/users/parametres", label: "Paramètres", icon: SettingsIcon },
      ],
    [items]
  );
