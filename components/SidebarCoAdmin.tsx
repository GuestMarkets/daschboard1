...
export default function SidebarSoft({
  ...
  const NAV: Item[] = React.useMemo(
    () =>
      items ?? [
        { href: "/guestmarkets/admin/overview", label: "Vue d’ensemble", icon: Home },
        {
          label: "Utilisateur",
          icon: Users,
          children: [
            { href: "/guestmarkets/admin/users", label: "Employés", icon: UsersIcon },
            { href: "/guestmarkets/admin/users/managers", label: "Responsables", icon: UserIcon },
          ],
        },
        { href: "/guestmarkets/admin/departements", label: "Départements", icon: Building2 },
        {
          label: "Projets",
          icon: FolderKanban,
          children: [
            { href: "/guestmarkets/admin/projets", label: "Pour moi", icon: UserIcon },
            { href: "/guestmarkets/admin/projets/tous", label: "Tout le monde", icon: UsersIcon },
          ],
        },
        {
          label: "Tâches",
          icon: CheckSquare,
          children: [
            { href: "/guestmarkets/admin/tasks/personnelle", label: "Pour moi", icon: ListChecks },
            { href: "/guestmarkets/admin/tasks", label: "Tout le monde", icon: UsersIcon },
          ],
        },
        { href: "/guestmarkets/admin/calendrier", label: "Calendrier", icon: CalendarIcon },
        { href: "/guestmarkets/admin/rapports", label: "Rapports", icon: BarChart3 },
        {
          label: "Planning",
          icon: CalendarCheck,
          children: [
            { href: "/guestmarkets/admin/planning", label: "Pour moi", icon: CalendarCheck },
            { href: "/guestmarkets/admin/planning/all", label: "Tout le monde", icon: CalendarCheck },
          ],
        },
        {
          label: "Objectifs",
          icon: Target,
          children: [
            { href: "/guestmarkets/admin/objectives", label: "Pour moi", icon: Target },
            { href: "/guestmarkets/admin/objectives/all", label: "Tout le monde", icon: Target },
          ],
        },
        { href: "/guestmarkets/admin/chat", label: "Chat", icon: MessageSquare },
        { href: "/guestmarkets/admin/parametres", label: "Paramètres", icon: SettingsIcon },
      ],
    [items]
  );
