...
export default function SidebarSoft({
  ...
  const NAV: Item[] = React.useMemo(
    () =>
      items ?? [
        { href: "/admin/overview", label: "Vue d’ensemble", icon: Home },
        { href: "/admin/users", label: "Employés", icon: Users },
        {
          label: "Départements",
          icon: Building2,
          children: [
            { href: "/admin/departements", label: "Employés", icon: UsersIcon },
            { href: "/admin/departements/managers", label: "Affectations", icon: UserIcon },
          ],
        },
        {
          label: "Projets",
          icon: FolderKanban,
          children: [
            { href: "/admin/projets", label: "Pour moi", icon: UserIcon },
            { href: "/admin/projets/tous", label: "Tout le monde", icon: UsersIcon },
          ],
        },
        {
          label: "Tâches",
          icon: CheckSquare,
          children: [
            { href: "/admin/tasks/personnelle", label: "Pour moi", icon: ListChecks },
            { href: "/admin/tasks", label: "Tout le monde", icon: UsersIcon },
          ],
        },
        { href: "/admin/calendrier", label: "Calendrier", icon: CalendarIcon },
        { href: "/admin/rapports", label: "Rapports", icon: BarChart3 },
        {
          label: "Planning",
          icon: CalendarCheck,
          children: [
            { href: "/admin/planning", label: "Pour moi", icon: CalendarCheck },
            { href: "/admin/planning/all", label: "Tout le monde", icon: CalendarCheck },
          ],
        },
        {
          label: "Objectifs",
          icon: Target,
          children: [
            { href: "/admin/objectives", label: "Pour moi", icon: Target },
            { href: "/admin/objectives/all", label: "Tout le monde", icon: Target },
          ],
        },
